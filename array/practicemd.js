...
// Write a program that uses a for loop to iterate through the numbers from 1 to 20. If the number is even, add it to a total sum.
//  At the end of the loop, print the total sum of all even numbers between 1 and 20.
